  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Directionality(
        textDirection: selectedLang == 0 ? TextDirection.ltr : TextDirection.rtl,
        child: Scaffold(
                ...
                child: Column(
                  children: [
                                ...
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                                      ...
                                      border: isSelected
                                          ? Border.all(color: Color(0xFFFFBB3B), width: 4)
                                          : null,
                                      boxShadow: isSelected
                                          ? [
                                        BoxShadow(
                                          color: Color(0xFFFFBB3B).withOpacity(0.25),
                                          blurRadius: 16,
                                          spreadRadius: 2,
                                        ),
                                      ]
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundColor: Colors.transparent,
                                      backgroundImage: AssetImage(avatars[index]['asset']!),
                                    ),
                                  ),
                    ...
                    _customField(
                      ...
                      hint: localizedTexts['password']![selectedLang],
                      isPassword: true,
                    ...
                    _customField(
                      iconAsset: AppAssets.passwordIcn,
                      hint: localizedTexts['confirmPassword']![selectedLang],
                      isPassword: true,
  ...
  Widget _languageSwitcherCircle() {
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          AnimatedAlign(
            alignment: selectedLang == 0 ? Alignment.centerLeft : Alignment.centerRight,
          ...
          if (isPassword && suffixAsset != null)
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Image.asset(suffixAsset, width: 28, height: 28, color: Colors.white),
              ),
            ),
        ],
      ),
